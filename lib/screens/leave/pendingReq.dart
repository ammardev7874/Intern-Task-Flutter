            ...
            child: Column(
              ...
              children: [
                ...
                Expanded(
                  child: Row(
                    children: [
                      Container(height: height*0.059,width: width*0.35,color: Color(0xffD1EFEA),child: Center(child: Text("APPROVE",style:TextStyle(color: Color(0xff319582),fontSize: height*0.013) ,)),),
                      Container(height: height*0.049,width: width*0.36,color: Color(0xffFFE8E8),child: Center(child: Text("REJECT",style:TextStyle(color: Color(0xffFF3535),fontSize: height*0.013) ,)),),
                        Container(height: height*0.049,width: width*0.162,color: Colors.white,child: Center(child: Text("EDIT",style:TextStyle(color: Color(0xff2F80ED),fontSize: height*0.013) ,)),),
